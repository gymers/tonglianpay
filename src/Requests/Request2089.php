 ...
 * 预约购买申请
*/
class Request2089 extends Request
{
    /**
     * @var string 合作商户号
     * C 8~10
    ...
    */
    ...
    /**
     * @var string 支付限制
     * C 0-9 支付方式为 A~Z、8 和 9 时 可选填不传时默认支持贷记卡与借记卡，上送：no_credit 不可使用贷记卡支付；
    */
    public $pay_limit = '';
     ...
     * @var string 冻结资金所在账户
     * M 1 1：现金账户 9：中间账户
     * （1）预约购买类型为 0，账户类型为 1 时可选 1，9
     * （2）预约购买类型为 0，账户类型为 2 时，仅可选 9
     * （3）预约购买类型为 3，仅可选 9
     * （4）预约购买类型为 4，仅可选 9
    */
    ...
    */
    ...
    /**
     * @var string 账户类型
     * C 1 1：借记卡 2：贷记卡 6：对公账户 预约购买类型 4 不填
    */
    public $acct_type = '';
    ...
    */
    ...
    /**
     * @var string 交易子账户
     * C 17 余额支付时，【银行编码、账户类型、账号】和【交易子账户】二选一必填
    */
    public $acct_sub_no = '';
    ...
    */
    ...
    /**
     * @var string 订单支付信息
     * C JSON串; 购买类型 4 订单支付必填，格式见订单支付功能说明
     *
     * 订单支付信息 JSON 如下：
